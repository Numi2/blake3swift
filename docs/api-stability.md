...
| Benchmark executable | Experimental | Output format may change until JSON/CSV output is formalized. |
...
- `BLAKE3.Context(maxWorkers:)` pins the reusable CPU scheduler worker count for repeated hashes and benchmark reproducibility.
